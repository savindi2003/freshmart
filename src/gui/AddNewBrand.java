...
public class AddNewBrand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New Product Brand");
        ...
        jLabel6.setText("Product Brands");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (name.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Brand name must be less than 20 characters", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                if (jButton1.getText().equals("Update")) {
                    ...
                    try {
                        ...
                        MySQL.execute("UPDATE `brand` SET `name` = '" + name + "' WHERE `id` = '" + id + "'   ");

                        final ImageIcon icon = new ImageIcon("src/Resources/correct.png");
                        JOptionPane.showMessageDialog(this, "Brand name updated Successfully", "Product Management", JOptionPane.INFORMATION_MESSAGE, icon);
                        reset();
                        loadBrand();
                        jButton1.setText("Add");
                    ...
                    ResultSet resultSet = MySQL.execute("SELECT * FROM `brand` WHERE `id`='" + id + "'  ");

                    if (resultSet.next()) {
                        JOptionPane.showMessageDialog(this, "Brand ID is already exist", "Product Management", JOptionPane.INFORMATION_MESSAGE);
                    } else {

                        ResultSet resultSet2 = MySQL.execute("SELECT * FROM `brand` WHERE `name`='" + name + "' ");
                        if (resultSet.next()) {
                            JOptionPane.showMessageDialog(this, "Brand Name is already exist", "Product Management", JOptionPane.INFORMATION_MESSAGE);
                        } else {

                            try {

                                MySQL.execute("INSERT INTO `brand` (`name`) VALUES ('" + name + "') ");

                                final ImageIcon icon = new ImageIcon(getClass().getResource("/Resources/correct.png"));
                                JOptionPane.showMessageDialog(this, "Brand Added Successfully", "Product Management", JOptionPane.INFORMATION_MESSAGE, icon);
                                reset();
                                loadBrand();
