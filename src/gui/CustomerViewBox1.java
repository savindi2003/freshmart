 ...
 * @author Savindi
 */
public class CustomerViewBox1 extends javax.swing.JFrame {

    private Invoice_1_1 invoice;

    public void setCustomer(Invoice_1_1 invoice) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        AddNewCustomerView1 ac = new AddNewCustomerView1();
        ac.setVisible(true);
        ac.setCus1(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerViewBox1().setVisible(true);
            }
        });
    }
