 ...
 * @author Savindi
 */
public class OutOfStockProduct extends javax.swing.JFrame {
    ...
    private void printReport() {
        ...
        try {
            ...
            InputStream reportStream = getClass().getResourceAsStream("/reports/OutOfStock.jasper");
...
printReport();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OutOfStockProduct().setVisible(true);
            }
        });
    }
