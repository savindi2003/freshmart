 ...
 * @author Savindi
 */
public class StockBoxDamage extends javax.swing.JFrame {

    /**
     * Creates new form UserManagement
     */
    private DamageProduct damageProducts;

    public void setProduct(DamageProduct damageProducts) {
        this.damageProducts = damageProducts;
    }

    public StockBoxDamage() {
        initComponents();
        loadCategory();
        loadBrand();
        loadTable();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
            ...
            if (evt.getClickCount() == 2) {
                ...
                if (damageProducts != null) {

                    

                    damageProducts.getId().setText(String.valueOf(jTable1.getValueAt(selectedRow, 0)));
                    damageProducts.getCategory().setText(String.valueOf(jTable1.getValueAt(selectedRow, 2)));
                    damageProducts.getBrand().setText(String.valueOf(jTable1.getValueAt(selectedRow, 3)));
                    damageProducts.getProductName().setText(String.valueOf(jTable1.getValueAt(selectedRow, 1)));
                    damageProducts.getPrice().setText(String.valueOf(jTable1.getValueAt(selectedRow, 9)));
                    damageProducts.getQty().setText(String.valueOf(jTable1.getValueAt(selectedRow, 7)));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockBoxDamage().setVisible(true);
            }
        });
    }
