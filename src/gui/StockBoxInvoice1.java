 ...
 * @author Savindi
 */
public class StockBoxInvoice1 extends javax.swing.JFrame {

    /**
     * Creates new form UserManagement
     */
    private Invoice_1_1 products;

    public void setProduct(Invoice_1_1 products) {
        this.products = products;
    }

    public StockBoxInvoice1() {
        initComponents();
        loadCategory();
        loadBrand();
        loadTable();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockBoxInvoice1().setVisible(true);
            }
        });
    }
