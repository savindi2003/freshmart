...
public class SupplierViewBox1 extends javax.swing.JFrame {

    private ReturnProducts returnProducts;

    public void setSupplier(ReturnProducts returnProducts) {
        this.returnProducts = returnProducts;
    }

    public SupplierViewBox1() {
        initComponents();
loadTable();
        loadCompany();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if(returnProducts != null){
                ...
                returnProducts.getSupCom().setText(String.valueOf(jTable1.getValueAt(selectRow, 1)));
                returnProducts.getSupMo().setText(String.valueOf(jTable1.getValueAt(selectRow, 4)));
                returnProducts.getSupName().setText(fname+" "+lname);
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try {
            ...
            ResultSet rs = MySQL.execute("SELECT * FROM `supplier` "
                    + "INNER JOIN `company` ON `supplier`.`company_id` = `company`.`id` WHERE `company`.`name` = '"+company+"' ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupplierViewBox1().setVisible(true);
            }
        });
    }
