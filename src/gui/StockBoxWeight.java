 ...
 * @author Savindi
 */
public class StockBoxWeight extends javax.swing.JFrame {

    /**
     * Creates new form UserManagement
     */
        private GoodsWeights goodWeigth;

    public void setProduct(GoodsWeights goodWeigth) {
        this.goodWeigth = goodWeigth;
    }

    public StockBoxWeight() {
        initComponents();
        loadCategory();
        loadBrand();
        loadTable();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
            ...
            if (evt.getClickCount() == 2) {
                ...
                if (goodWeigth != null) {
                    ...
                    goodWeigth.getId().setText(String.valueOf(jTable1.getValueAt(selectedRow, 0)));
                    goodWeigth.getProductName().setText(String.valueOf(jTable1.getValueAt(selectedRow, 1)));
                    goodWeigth.getPrice().setText(String.valueOf(jTable1.getValueAt(selectedRow, 8)));
                    goodWeigth.getUnit().setText(String.valueOf(jTable1.getValueAt(selectedRow, 4)));
                    
                    goodWeigth.loadTabel();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockBoxWeight().setVisible(true);
            }
        });
    }
