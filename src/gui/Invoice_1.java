 ...
 * @author Savindi
 */
public class Invoice_1 extends javax.swing.JFrame {

    HashMap<String, InvoiceItemM> invoiceItemMap = new HashMap<>();

    public Invoice_1(String username) {
        initComponents();
...
//                qty = Double.parseDouble(wqty);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        StockBoxInvoice st = new StockBoxInvoice();
        st.setVisible(true);
        st.setProduct(this);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CustomerViewBox cs = new CustomerViewBox();
        cs.setVisible(true);
        cs.setCustomer(this);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String username = jLabel33.getText();
        SellingHistory sh = new SellingHistory(username);
        sh.setVisible(true);
        this.dispose();
