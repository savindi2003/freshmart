...
public class AddNewCustomer extends javax.swing.JFrame {
    ...
    private CustomerManagement customerMg;
    private CustomerViewBox customerV;
    
    public void setCus(CustomerManagement customerMg){
        this.customerMg = customerMg;
    }
    public void setCus1(CustomerViewBox customerV){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String last = jTextField7.getText();
        ...
        try {
            if (mobile.isEmpty()) {
                ...
                MySQL.execute("INSERT INTO `customer` (`mobile`,`fname`,`lname`,`points`,`registerd_date`) "
                        + "VALUES ('" + mobile + "' , '" + first + "' , '" + last + "','0','"+datetime+"') ");

                final ImageIcon icon = new ImageIcon(getClass().getResource("/Resources/correct.png"));
                JOptionPane.showMessageDialog(this, "Customer added successfully", "Customer Management", JOptionPane.INFORMATION_MESSAGE, icon);
                reset();
                customerMg.loadTable();
                customerV.loadTable();
