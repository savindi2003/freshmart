 ...
 * @author Savindi
 */
public class StockBox extends javax.swing.JFrame {
    ...
    public void setProduct(ReturnProducts returnProducts) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
            ...
            if (evt.getClickCount() == 2) {
                ...
                if (returnProducts != null) {
                    ...
                    returnProducts.getId().setText(String.valueOf(jTable1.getValueAt(selectedRow, 0)));
                    returnProducts.getCategory().setText(String.valueOf(jTable1.getValueAt(selectedRow, 2)));
                    returnProducts.getBrand().setText(String.valueOf(jTable1.getValueAt(selectedRow, 3)));
                    returnProducts.getProductName().setText(String.valueOf(jTable1.getValueAt(selectedRow, 1)));
                    returnProducts.getPrice().setText(String.valueOf(jTable1.getValueAt(selectedRow, 9)));
                    returnProducts.getQty().setText(String.valueOf(jTable1.getValueAt(selectedRow, 7)));
