 ...
 * @author Savindi
 */
public class CompanyMng extends javax.swing.JFrame {

    /**
     * Creates new form UserManagement
     */
    public CompanyMng(String username) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Supplier Company Management");
...
//                try {
//
//                    MySQL.execute(" DELETE FROM `company` WHERE `name` = '" + name + "' ");
//
//                    final ImageIcon icon = new ImageIcon("src/Resources/correct.png");
//                    JOptionPane.showMessageDialog(this, "Company Removed Successfully", "Supplier Management", JOptionPane.INFORMATION_MESSAGE, icon);
//
//                    loadTable();
//                    reset();
//
...
//                }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AddNewCompany newCom = new AddNewCompany();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String hotline = String.valueOf(jTable1.getValueAt(selectedRow, 2));
        ...
        try {
            ...
            if (name.isEmpty()) {
                ...
                try {
                    ...
                    MySQL.execute(" UPDATE `company` SET "
                            + " `name` = '" + name + "' , "
                            + "`hotline` = '" + hotline + "' , `email` = '" + email + "'  WHERE `id` = '" + cid + "' ");
