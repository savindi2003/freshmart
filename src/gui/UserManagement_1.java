...
public class UserManagement_1 extends javax.swing.JFrame {

    public static HashMap<String, Integer> GenderMap = new HashMap();
    public static HashMap<String, Integer> UsertypeMap = new HashMap();
    public static HashMap<String, Integer> UserStatusMap = new HashMap();
    

    public UserManagement_1(String username) {
        initComponents();
    ...
    private void loadStatus() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                UserStatusMap.put(resultSet.getString("name"), resultSet.getInt("id"));
            }
    ...
    public void loadUserTable() {
        try {
            ...
            ResultSet rs = MySQL.execute("SELECT * FROM `user` "
                    ...
                    + "INNER JOIN `status` ON `status`.`id` = `user`.`user_status_id`  ");
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("user_type.type"));
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Date Registerd");
        ...
        jLabel20.setFont(new java.awt.Font("Quicksand Medium", 0, 12)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Username", "First Name", "Last Name", "Mobile", "Password", "NIC", "Date Registerd", "Gender", "User Type", "Status"
            }
        ) {
        ...
        jButton2.setText("Assign Permission");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        UserPermision up = new UserPermision(username);
        up.setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String username = String.valueOf(jTable1.getValueAt(selectedRow, 1));
            ...
            String uType = String.valueOf(jTable1.getValueAt(selectedRow, 9));
            jComboBox2.setSelectedItem(uType);

            String status = String.valueOf(jTable1.getValueAt(selectedRow, 10));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int typeId = UsertypeMap.get(type);
        int statusId = UserStatusMap.get(status);
        ...
        try {
            ...
            if (fname.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Invalid Mobile Number Input Input", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "Please Select Employee Status", "Warning", JOptionPane.WARNING_MESSAGE);
            } else {
                ...
                try {
                    ...
                    MySQL.execute(" UPDATE `user` SET "                            
                            ...
                            + "`gender_id` = '" + genderId + "' ,"
                            + " `user_type_id` = '" + typeId + "' , "
                            + "`user_status_id` = '" + statusId + "' WHERE `username` = '"+uname+"'  ");
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        ...
        try {
            ...
            ResultSet rs = MySQL.execute("SELECT * FROM `user` "
                    ...
                    + "INNER JOIN `gender` ON `gender`.`id` = `user`.`gender_id` "
                    + "INNER JOIN `status` ON `status`.`id` = `user`.`user_status_id` "
                    + "WHERE `username` LIKE '%"+search+"%' OR `fname` LIKE '%"+search+"%' OR `lname` LIKE '%"+search+"%'  ");
